...
const addAppointmentMutation = {
  ...
  async resolve(parent, args, context) {
    ...
    const createEventObject = (appointment) => {
      const eventObject = {
        title: "High End Barbershop Appointment",
        location: "20210 Stone Oak Parkway, San Antonio, Texas, 78258",
      ...
      client.messages
        .create({
          body:
            ...
            "! Your High End Barbershop appointment has been scheduled for " +
        ...
        mjmlUtils
          ...
          .then(async (finalTemplate) => {
            await transporter.sendMail({
              ...
              to: client_res.email,
              subject: "Your High End Appointment",
              html: finalTemplate,
            });
          });
      ...
      mjmlUtils
        ...
        .then(async (finalTemplate) => {
          await transporter.sendMail({
            ...
            subject: "Your High End Barbershop Appointment",
            html: finalTemplate,
          });
        });
