      ...
      client.messages
        .create({
          body:
            ...
            "! This is a reminder for your High End Barbershop appointment tomorrow, " +
      ...
      client.messages
        .create({
          body:
            ...
            appointment.client.firstName[0].toUpperCase() +
            appointment.client.firstName.slice(1).toLowerCase() +
            "! We look forward to seeing you at your High End appointment today at " +
            appointment.startTime +
            ". " +
...
mongoose
  .connect(
    `mongodb+srv://${process.env.MONGO_DB_USERNAME}:${process.env.MONGO_DB_PASSWORD}@highendbarbershop.vx5gqdu.mongodb.net/?retryWrites=true&w=majority`,
